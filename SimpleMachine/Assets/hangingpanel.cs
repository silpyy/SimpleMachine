...
public class hangingpanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        messageObject = GameObject.Find("Canvas/hangingpanel/Text");
        messageText = GameObject.Find("Canvas/hangingpanel/Text")?.GetComponent<Text>();
    ...
    {
        string message = data.SelectNodes("/strings/" + "string[@id='text8']")[0].InnerText.ToString();
